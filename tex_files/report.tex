...
\begin{itemize}
\item Define series estimator
\item Parameters - choice of basis function and dimensionality $D$
\item Compare to Kernel Density estimates (Kernel and h)
\item Suppose $D$ is fixed - what is Bias, Variance, MSE, MISE
\item develop PSE 
\item Connect MISE and PSE 
\end{itemize}
